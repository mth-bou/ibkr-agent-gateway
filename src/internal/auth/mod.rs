...
pub use scopes::{
    ACCOUNTS_READ, AUDIT_READ, HEALTH_READ, LIVE_SCOPES, LOCAL_SCOPES, MARKETDATA_READ,
    ORDERS_LIVE_CANCEL, ORDERS_LIVE_SUBMIT, ORDERS_PAPER_CANCEL, ORDERS_PAPER_SUBMIT,
    ORDERS_PREVIEW, ORDERS_READ, PAPER_SCOPES, PORTFOLIO_READ, POSITIONS_READ, PREVIEW_SCOPES,
    READ_SCOPES, RISK_READ, ScopeSet, is_local_scope, is_read_scope, require_scope,
};
